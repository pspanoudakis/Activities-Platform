                ...
                </div>
                {
                    ...
                    (
                        ...
                        <div className="flex flex-row gap-2 items-center">
                            ...
                            <NavbarButton bgColor="bg-white hover:bg-light-cyan" title="ΕΓΓΡΑΦΗ" callback={() => console.log('sign up')} />
                            <NavbarButton bgColor="bg-white hover:bg-light-cyan" title="ΣΥΝΔΕΣΗ" callback={() => console.log('sign in')} />
                        </div>
                    )
                }
            </div>
